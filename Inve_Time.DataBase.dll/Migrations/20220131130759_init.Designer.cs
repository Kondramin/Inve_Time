...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inve_Time.Entities.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Inve_Time.Entities.Entities.CategorySearchWord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Inve_Time.Entities.Entities.InventoryEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Inve_Time.Entities.Entities.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Inve_Time.Entities.Entities.ProductInvented", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InventoryEventProductInvented", b =>
                {
                    b.Property<int>("InventoryEventsId")
                        .HasColumnType("int");

                    b.Property<int>("ProductInventedsId")
                        .HasColumnType("int");

                    b.HasKey("InventoryEventsId", "ProductInventedsId");

                    b.HasIndex("ProductInventedsId");

                    b.ToTable("InventoryEventProductInvented");
                });

            modelBuilder.Entity("Inve_Time.Entities.Entities.CategorySearchWord", b =>
                {
                    b.HasOne("Inve_Time.Entities.Entities.Category", "Category")
            ...
            modelBuilder.Entity("Inve_Time.Entities.Entities.Employee", b =>
                {
                    b.HasOne("Inve_Time.Entities.Entities.Market", "Market")
                        .WithMany("Staff")
            ...
            modelBuilder.Entity("Inve_Time.Entities.Entities.InventoryEvent", b =>
                {
                    b.HasOne("Inve_Time.Entities.Entities.Employee", "ResponsibleEmployee")
            ...
            modelBuilder.Entity("Inve_Time.Entities.Entities.ProductInvented", b =>
                {
                    b.HasOne("Inve_Time.Entities.Entities.Product", "ProductInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("InventoryEventProductInvented", b =>
                {
                    b.HasOne("Inve_Time.Entities.Entities.InventoryEvent", null)
                        .WithMany()
                        .HasForeignKey("InventoryEventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Inve_Time.Entities.Entities.ProductInvented", null)
                        .WithMany()

...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inve_Time.DataBase.dll.Entities.HelpCategorySearch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("HelpCategorySearchers");
            ...
            modelBuilder.Entity("Inve_Time.DataBase.dll.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CurrentInventarisationProduct", b =>
                {
                    ...
                    b.HasOne("Inve_Time.DataBase.dll.Entities.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Inve_Time.DataBase.dll.Entities.HelpCategorySearch", b =>
                {
                    b.HasOne("Inve_Time.DataBase.dll.Entities.Category", "Category")
                        .WithMany("HelpCategorySearchers")
